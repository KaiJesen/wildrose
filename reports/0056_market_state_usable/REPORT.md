# 0056_market_state_usable 多任务市场状态模型训练报告

## 实验依据

- `document/003_理想模型指标目标/架构师-003-理想模型指标目标指导.md`
- `document/002_模型指标训练指导/架构师-002-模型指标训练指导.md`
- `document/003_理想模型指标目标/软件设计师_003_市场状态模型最终训练建议[训练建议].md`
...
- epochs=40, early_stop_patience=25
...
| 指标 | 0056_market_state_usable | 0050 |
|------|------|------|
| cum_direction_acc | 54.7% | 54.7% |
| direction_acc | 30.0% | 32.2% |
| direction_macro_f1 | 0.289 | 0.318 |
| return_ic | 0.042 | 0.029 |
| return_mae | 0.029310 | 0.040444 |
| volatility_mae | 0.075316 | 0.091253 |
| risk_f1 | 0.532 | 0.520 |
| loss | 0.7839 | 0.7740 |

## 最佳验证集

- composite_score=0.3874
- cum_direction_acc=56.5%
- direction_macro_f1=0.324
- return_ic=0.021
- risk_f1=0.530
- volatility_mae=0.077956

## 测试诊断

- direction_pred: `{'direction_pred_c0': 0.224, 'direction_pred_c1': 0.312, 'direction_pred_c2': 0.464}`
- risk_positive_rate_true/pred: 0.232 / 0.407
...
- 未达标项: cum_direction_acc>=56%, direction_macro_f1>=0.30
