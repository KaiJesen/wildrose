# 0058_market_state_usable 多任务市场状态模型训练报告
...
| 指标 | 0058_market_state_usable | 0050 |
|------|------|------|
| cum_direction_acc | 60.8% | 54.7% |
| direction_acc | 31.2% | 32.2% |
| direction_macro_f1 | 0.308 | 0.318 |
| return_ic | 0.054 | 0.029 |
| return_mae | 0.035691 | 0.040444 |
| volatility_mae | 0.088098 | 0.091253 |
| risk_f1 | 0.530 | 0.520 |
| loss | 0.8144 | 0.7740 |
...
- direction_macro_f1=0.285
- return_ic=0.039
- risk_f1=0.487
- volatility_mae=0.081339

## 测试诊断

- direction_pred: `{'direction_pred_c0': 0.189, 'direction_pred_c1': 0.508, 'direction_pred_c2': 0.303}`
- risk_positive_rate_true/pred: 0.232 / 0.461
