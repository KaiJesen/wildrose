# 0062f_market_state_return_ic_recovery 多任务市场状态模型训练报告
...
- return/direction/volatility/risk = 0.42/0.25/0.1/0.09
...
| 指标 | 0062f_market_state_return_ic_recovery | 0059c balanced |
|------|------|------|
| cum_direction_acc | 58.8% | 56.1% |
| cum_direction_head_acc | 59.5% |
| cum_direction_from_return_acc | 58.8% |
| direction_acc | 34.6% | 34.6% |
| direction_macro_f1 | 0.326 | 0.341 |
| return_ic | 0.003 | 0.038 |
| cum_return_ic | 0.139 |
| return_mae | 0.036268 | 0.023671 |
| cum_return_mae | 0.155754 |
| volatility_mae | 0.054264 | 0.061748 |
| risk_f1 | 0.548 | 0.542 |
| loss | 0.4862 | 0.7289 |

## 最佳验证集

- composite_score=0.3040
- cum_direction_acc=51.0%
- cum_direction_head_acc=51.7%
- cum_direction_from_return_acc=51.0%
- direction_macro_f1=0.355
- return_ic=-0.016
- cum_return_ic=0.045
- risk_f1=0.510
- volatility_mae=0.053261
- best_selection_mode=hard_gated
- no_valid_checkpoint=False

## 验证集分布（最佳 checkpoint）

- direction_pred: `{'direction_pred_c0': 0.397, 'direction_pred_c1': 0.201, 'direction_pred_c2': 0.401}`
- risk_positive_rate_true/pred: 0.336 / 0.267

## 测试诊断

- direction_pred: `{'direction_pred_c0': 0.396, 'direction_pred_c1': 0.201, 'direction_pred_c2': 0.403}`
- risk_positive_rate_true/pred: 0.232 / 0.245

- risk_precision/recall: 0.304 / 0.320
- direction_recall down/flat/up: 0.390 / 0.174 / 0.422
