# 0063_multi_seed_s43_market_state_stability 多任务市场状态模型训练报告
...
| 指标 | 0063_multi_seed_s43_market_state_stability | 0059c balanced |
|------|------|------|
| cum_direction_acc | 62.2% | 56.1% |
| cum_direction_head_acc | 60.8% |
| cum_direction_from_return_acc | 62.2% |
| direction_acc | 35.7% | 34.6% |
| direction_macro_f1 | 0.336 | 0.341 |
| return_ic | 0.005 | 0.038 |
| cum_return_ic | 0.133 |
| return_mae | 0.027387 | 0.023671 |
| cum_return_mae | 0.120713 |
| volatility_mae | 0.045045 | 0.061748 |
| risk_f1 | 0.556 | 0.542 |
| loss | 0.4425 | 0.7289 |
...
- cum_direction_head_acc=51.0%
- cum_direction_from_return_acc=50.3%
- direction_macro_f1=0.364
- return_ic=-0.015
- cum_return_ic=0.043
- risk_f1=0.507
- volatility_mae=0.045385
- best_selection_mode=hard_gated
- no_valid_checkpoint=False

## 验证集分布（最佳 checkpoint）

- direction_pred: `{'direction_pred_c0': 0.39, 'direction_pred_c1': 0.2, 'direction_pred_c2': 0.41}`
...
- risk_positive_rate_true/pred: 0.232 / 0.264

- risk_precision/recall: 0.313 / 0.355
