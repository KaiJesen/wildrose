...
@dataclass(frozen=True)
class SlowUpParticipationGateConfig(ChannelEdgeMixConfig):
    enabled: bool = False
    tau_slow: float = 0.55
...
@dataclass(frozen=True)
class StdTrendParticipationGateConfig(ChannelEdgeMixConfig):
    enabled: bool = False
    calibration_path: str = ""
...
class ParticipationChannelConfig:
    ...
    std_trend_gate: StdTrendParticipationGateConfig = StdTrendParticipationGateConfig()
...
def load_config(path: str | Path) -> TradingSystemConfig:
    ...
    std_trend_gate_p = participation_channel_p.get("std_trend_gate", {})
    ...
    return TradingSystemConfig(
        ...
        participation_channel=ParticipationChannelConfig(
            ...
            std_trend_gate=StdTrendParticipationGateConfig(
                **{**StdTrendParticipationGateConfig().__dict__, **std_trend_gate_p}
            ),
        ),
