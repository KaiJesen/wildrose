...
| 依据 | `document/021/软件设计师-021-TrendBiasContext最终字段契约.md`（冻结 schema）、`document/021/软件设计师-021-TrendBiasBuilder冲突裁决表.md`、`document/021/软件设计师-021-偏置数学公式说明.md` |
| 架构复审 | `document/021/架构师-021-趋势优先交易框架立项材料复审报告.md` |
